(function($) {
   ...
   if ($('.accordion-box').length) {
    ...
    /* ================================
      Hero Slider Js Start — délai 6s
    ================================ */
     if($('.hero-slider').length > 0) {
        console.log("hero-slider trouvé, slides:", $('.hero-slider .swiper-slide').length);
    ...
    /* ================================
       Banner Active Js Start — délai 6s
    ================================ */
    ...
    /* ================================
      Program Slider Js Start — délai 5s
    ================================ */
   ...
   /* ================================
      Extra Activities Slider Js Start — délai 5s
    ================================ */
   if ($('.extra-activities-slider').length > 0) {
    ...
    /* ================================
      Brand Slider Js Start — délai 5s
    ================================ */
   ...
   if ($('.team-slider').length > 0) {
    ...
    if (typeof gsap !== "undefined") {
        ...
        mm.add("(min-width: 1200px)", () => {
            ...
            $('.tz-sub-tilte').each(function (index, el) {
                let split = new SplitText(el, { type: "lines,words,chars", linesClass: "split-line" });
                splits.push(split);
    ...
    if ($('.bz-gsap-animate-circle').length) {
        gsap.utils.toArray('.bz-gsap-animate-circle').forEach((el) => {
            ...
            gsap.timeline({
                scrollTrigger: { trigger: el, scrub: 1, start: "top 80%", end: "top 20%", markers: false }
            })
