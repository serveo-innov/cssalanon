...
@section('title', 'Événements – CS SALANON')
...
@section('content')
        ...
        <div class="container">
            <div class="page-heading">
                <div class="breadcrumb-sub-title">
                    <h1 class="wow fadeInUp" data-wow-delay=".3s">Nos Événements</h1>
                </div>
    ...
    <section class="activities-section fix section-padding bg-cover" style="background-image: url('{{ asset('assets/img/home-1/classes-bg.png') }}');">
        <div class="container">
            ...
            <div class="activities-wrapper-items style-event {{ $i === 1 ? 'active' : '' }} wow fadeInUp" data-wow-delay="{{ ($i * 0.2 + 0.3) . 's' }}">
                <div class="date-top"><img src="{{ asset('assets/img/inner-page/date.png') }}" alt=""></div>
