...
@section('content')
    ...
    {{-- ==================== PROGRAM SECTION ==================== --}}
    {{--
        GUIDE : Chaque programme expose :
        • 'img'   → photo de la classe dans assets/img/home-1/
        • 'age'   → tranche d'âge affichée sur la carte
        • 'title' → nom du programme
        • 'slug'  → doit correspondre au slug dans ProgramController
        • 'desc'  → texte descriptif propre à ce programme
        • 'duree' → durée affichée sur la carte
        • 'color' → classe CSS pour la couleur de la durée ('', 'color-2', 'color-3')
        • 'bg'    → classe CSS de fond ('', 'bg-2', 'bg-3')
    --}}
    @php
    $programs_home = [
        [
            ...
            'bg'    => '',
            'age'   => '3-5 ans',
            'title' => 'Maternelle I & II',
            'slug'  => 'maternelle',
            'desc'  => 'Un cadre doux et sécurisé où les tout-petits découvrent le monde par le jeu, le dessin et la musique. Nos éducatrices qualifiées accompagnent chaque enfant avec patience et bienveillance.',
        ...
        [
            ...
            'title' => 'Primaire',
            'slug'  => 'primaire',
            'desc'  => 'Le cycle primaire pose les bases essentielles : lecture, écriture, calcul et éveil scientifique. Une pédagogie active et rigoureuse prépare chaque élève au succès au CEP et au-delà.',
            'duree' => 'Journée complète',
            'color' => 'color-2',
            'delay' => '.4s',
        ],
        [
            ...
            'bg'    => 'bg-3',
            'age'   => '10 ans+',
            'title' => 'Secondaire (Cycle I & II)',
            'slug'  => 'secondaire',
            'desc'  => 'Du 6ᵉ à la Terminale ABCD, nos enseignants spécialisés encadrent les élèves vers l\'excellence au BEPC et au BAC. Un suivi personnalisé garantit la réussite de chacun.',
            'duree' => 'Journée complète',
            'color' => 'color-3',
            'delay' => '.6s',
        ],
            ...
            <div class="program-wrapper">
                ...
                <div class="program-wrap-items swiper program-slider">
                    <div class="swiper-wrapper wow fadeInUp" data-wow-delay=".3s">
                        @foreach ($programs_home as $program)
                        <div class="swiper-slide">
                            <div class="program-main-box-items">
                                <div class="program-box-items">
                                    <div class="item-bg {{ $program['bg'] }}"></div>
                                    <div class="thumb">
                                        <img src="{{ asset('assets/img/home-1/' . $program['img']) }}" alt="{{ $program['title'] }}">
                                        <img src="{{ asset('assets/img/home-1/' . $program['img']) }}" alt="{{ $program['title'] }}">
                                    </div>
                                    <div class="content">
                                        ...
                                        <p>{{ $program['desc'] }}</p>
                                        <span class="duration-text {{ $program['color'] }}">Durée : {{ $program['duree'] }}</span>
                                    </div>
                                </div>
                                <div class="arrow-btn">
    ...
    {{-- ==================== ACTIVITIES SECTION ==================== --}}
    {{--
        GUIDE : Chaque activité périscolaire expose :
        • 'num'    → numéro affiché (01, 02, 03...)
        • 'title'  → nom de l'activité
        • 'desc'   → description propre à cette activité
        • 'img'    → image dans assets/img/home-1/
        • 'slug'   → slug de l'événement lié dans EventController
        • 'active' → true = mis en avant visuellement
        • 'delay'  → délai d'animation WOW
    --}}
    @php
    $activities = [
    [
        'num'    => '01',
        'title'  => 'Art & Artisanat',
        'desc'   => 'Les élèves explorent leur créativité à travers le dessin, la peinture, le modelage et la fabrication d\'objets. Ces ateliers développent la motricité fine et l\'expression personnelle.',
        'img'    => 'activities-image.jpg',
    ...
    [
        'num'    => '02',
        'title'  => 'Musique & Danse',
        'desc'   => 'Chant choral, initiation aux instruments et chorégraphies rythmées : nos élèves s\'épanouissent par la musique et le mouvement, renforçant leur confiance en soi et leur sens du collectif.',
        'img'    => 'activities-image-2.jpg',
    ...
    [
        ...
        'desc'   => 'Football, athlétisme, jeux d\'équipe et relais : la journée sportive annuelle réunit tous les niveaux pour célébrer les valeurs du sport — persévérance, fairplay et esprit d\'équipe.',
        'img'    => 'activities-image-3.jpg',
        ...
        <div class="container">
            ...
            <div class="activities-wrapper-items {{ $activity['active'] ? 'active' : '' }} wow fadeInUp" data-wow-delay="{{ $activity['delay'] }}">
                ...
                <div class="content">
                    ...
                    <h3><a href="{{ route('event.show', $activity['slug']) }}">{{ $activity['title'] }}</a></h3>
                </div>
                <div class="right-items">
                    <div class="thumb-items">
                        <div class="thumb">
                            <img src="{{ asset('assets/img/home-1/' . $activity['img']) }}" alt="{{ $activity['title'] }}">
                            <img src="{{ asset('assets/img/home-1/' . $activity['img']) }}" alt="{{ $activity['title'] }}">
                        </div>
                        <a href="{{ route('event.show', $activity['slug']) }}" class="icon">
                            <span class="bg"></span>
                            <div class="arrow-icon">
                ...
                <div class="tetsimonial-box-items">
                    ...
                    <div class="content">
                        <div class="client-img">
                            <img src="{{ asset('assets/img/home-1/' . $testi['img']) }}"
                                 alt=""
