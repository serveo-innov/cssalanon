                    ...
                    <div class="col-lg-6">
                        <div class="choose-us-content">
                            ...
                            <a href="{{ route('programs') }}" class="theme-btn hover-header wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <span class="theme-text">Nos programmes <img src="{{ asset('assets/img/icon/arrow1.svg') }}" alt=""></span>
                                <span class="theme-text2">Nos programmes <img src="{{ asset('assets/img/icon/arrow1.svg') }}" alt=""></span>
                            </a>
                        </div>
                    </div>
                </div>
