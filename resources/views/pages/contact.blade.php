...
@section('title', 'Contact – École SALANON')
        ...
        <div class="container">
            <div class="page-heading">
                <div class="breadcrumb-sub-title">
                    <h1 class="wow fadeInUp" data-wow-delay=".3s">Contactez-nous</h1>
                </div>
                ...
                <div class="row g-4 align-items-center">
                        ...
                        <div class="contact-left-items">
                            <div class="contact-info-area-2">
                                ...
                                <div class="contact-info-items mb-4">
                                    ...
                                    <div class="content">
                                        <p>Appelez-nous 7j/7</p>
                                        <h2><a href="tel:+2290167725898">+229 01 93 83 83 92 / 01 67 72 58 98</a></h2>
                                    </div>
                                </div>
                                ...
                                <div class="contact-info-items mb-4">
                                    ...
                                    <div class="content">
                                        ...
                                        <h2><a href="mailto:contact@cssalanon.com">contact@cssalanon.com</a></h2>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-content">
                            ...
                            <p>
                                Vous avez une question sur les inscriptions, les programmes ou la vie scolaire ? Notre équipe vous répondra dans les plus brefs délais.
                            </p>
                            ...
                            <form action="{{ route('contact.send') }}" method="POST" class="contact-form-items">
                                @csrf
                                <div class="row g-4">
